        ...
        <section class="form_container">
            ...
            <el-form :model="loginUser" :rules="rules" ref="loginForm" class="loginForm" label-width="80px">
                ...
                <el-form-item label="密码" prop="password">
                    <el-input v-model="loginUser.password" @keyup.enter.native="submitForm('loginForm')" placeholder="请输入密码" type="password"></el-input>
                </el-form-item>
                <el-form-item>
    ...
    return {
      ...
      rules: {
        name:[
          ...
          {min:4,message:'长度大于6个字符',trigger:'blur'}
        ],
        email: [
          {
            type: "email",
